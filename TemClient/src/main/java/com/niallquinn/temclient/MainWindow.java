 ...
 */
package com.niallquinn.temclient;
...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Convert Fahrenheit to Celcius");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            try {
                ...
                Double value = this.getValueFromJSON(s);
                jLabel5.setText("" + value + " degrees Fahrenheit");
            } finally {
                response1.close();
            }

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "The input was not a valid number");
            return;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String celciusString = jTextField3.getText();
        if (celciusString.length() == 0) {
            JOptionPane.showMessageDialog(null, "No value entered");
            return;
        }
        try {
            ...
            try {
                ...
                String s = EntityUtils.toString(entity1);
                Double value = this.getValueFromJSON(s);
                jLabel8.setText("" + value + " degrees Celcius");
            } finally {
                response1.close();
            }
    ...
    private double getValueFromJSON(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        JsonNode rootNode;
        try {
            rootNode = mapper.readTree(jsonString);
            JsonNode dataNode = rootNode.get("data");
            JsonNode aField = dataNode.get("outputValue");
            String outputString = aField.asText();
            System.out.println("outputValue is:" + outputString);
